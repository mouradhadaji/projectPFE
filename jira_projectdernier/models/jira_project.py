...
class JiraProject(models.Model):
    ...
    def action_open_backlog_setup(self):
        return {
            'type': 'ir.actions.act_window',
            'name': 'Product Backlog',
            'res_model': 'jira.project',
            'view_mode': 'form',
            'view_id': self.env.ref('jira_project.view_jira_project_backlog_form').id,
            'target': 'current',
