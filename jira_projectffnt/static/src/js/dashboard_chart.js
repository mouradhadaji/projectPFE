...
(function() {
    ...
    let attempts = 0;
    const tryRender = setInterval(function() { attempts++; tryInit(); if (rendered || attempts >= 20) clearInterval(tryRender); }, 100);
    ...
    new MutationObserver(function() {
        if (location.href !== lastUrl) {
            ...
            rendered = false;
            if (lastUrl.includes('jira')) setTimeout(tryInit, 300);
        }
